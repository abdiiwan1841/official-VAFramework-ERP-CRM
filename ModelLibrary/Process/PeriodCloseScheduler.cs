        ...
        protected override string DoIt()
        {
            ...
            {                  
               string sql = "UPDATE C_PeriodControl SET PeriodStatus= '" + MPeriodControl.PERIODSTATUS_Closed + "'" +
                    ...
                    "WHERE IsActive='Y' AND y.C_Calendar_ID=" + calendar_id + " AND Startdate=" + GlobalVariable.TO_DATE(lastMonth, true)+ ") AND DocBaseType NOT IN ('" + MDocBaseType.DOCBASETYPE_GLJOURNAL + "')"+
                ...
                if ( Util.GetValueOfInt( DB.ExecuteQuery(sql, null, Get_Trx())) == 0)
                {
